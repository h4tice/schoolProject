...
namespace okulProje.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT TBLOGRENCİLER.OGRID, TBLOGRENCİLER.OGRAD, TBLOGRENCİLER.OGRSOYAD, TBLKULUP" +
                "LER.KULUPAD, TBLOGRENCİLER.OGRCİNSİYET\r\nFROM     TBLOGRENCİLER INNER JOIN\r\n     " +
                "             TBLKULUPLER ON TBLOGRENCİLER.OGRKULUP = TBLKULUPLER.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT TBLOGRENCİLER.OGRID, TBLOGRENCİLER.OGRAD, TBLOGRENCİLER.OGRSOYAD, TBLKULUPLER.KULUPAD, TBLOGRENCİLER.OGRCİNSİYET
FROM     TBLOGRENCİLER INNER JOIN
                  TBLKULUPLER ON TBLOGRENCİLER.OGRKULUP = TBLKULUPLER.KULUPID
WHERE  (TBLOGRENCİLER.OGRAD = @OGRAD)";
            ...
            this._commandCollection[3].CommandText = "UPDATE TBLOGRENCİLER\r\nSET          OGRAD = @OGRAD, OGRSOYAD = @OGRSOYAD, OGRKULUP" +
                " = @OGRKULUP, OGRCİNSİYET = @OGRCINSIYET\r\nWHERE  (OGRID = @OGRID)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
